...
exports.getVerificationFromProvider = exports.detectAIByBurstiness = exports.detectAIByStatistics = exports.detectAIByPatterns = exports.detectAIByPerplexity = void 0;
 ...
 */
const detectAIByPerplexity = (text) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.detectAIByPerplexity = detectAIByPerplexity;
/**
 * AI Detection Provider 2: Pattern-based detection
 * Looks for patterns commonly found in AI-generated text
 */
const detectAIByPatterns = (text) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.detectAIByPatterns = detectAIByPatterns;
/**
 * AI Detection Provider 3: Statistical analysis
 * Uses statistical methods to detect AI-generated content
 */
const detectAIByStatistics = (text) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.detectAIByStatistics = detectAIByStatistics;
/**
 * AI Detection Provider 4: Burstiness analysis
 * Human writing tends to be "burstier" - more variation in complexity and patterns
 */
const detectAIByBurstiness = (text) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Extract paragraphs
        ...
        const consistentStarts = paragraphs.filter(p => p.startsWith("The") || p.startsWith("This") || p.startsWith("In")).length;
...
exports.detectAIByBurstiness = detectAIByBurstiness;
/**
 * Get verification from any provider by ID
 */
const getVerificationFromProvider = (providerId, ipfsHash, hashKey) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Retrieve content from IPFS
        const contentObj = yield (0, ipfs_service_1.getFromIPFS)(ipfsHash);
        if (!contentObj) {
        ...
        switch (providerId) {
            case 'provider1':
                return yield (0, exports.detectAIByPerplexity)(content);
            case 'provider2':
                return yield (0, exports.detectAIByPatterns)(content);
            case 'provider3':
                return yield (0, exports.detectAIByStatistics)(content);
            case 'provider4':
                return yield (0, exports.detectAIByBurstiness)(content);
            default:
...
exports.getVerificationFromProvider = getVerificationFromProvider;
