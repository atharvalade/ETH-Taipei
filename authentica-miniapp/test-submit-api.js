// Test script for the miniapp's submit-content API endpoint
...
const testMiniappFlow = async () => {
  console.log('AUTHENTICA MINIAPP API TEST\n');
  
  // Test parameters
  const content = `This is a human-written paragraph about blockchain technology.
I believe that decentralized systems offer unique advantages for verifying
content authenticity. The use of IPFS for storage combined with NFT minting
provides a powerful framework for proving ownership and origin of digital content.`;
