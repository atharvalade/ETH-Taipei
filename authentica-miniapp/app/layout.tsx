          ...
          <ErudaProvider>
            <MiniKitProvider>
              ...
              <div className="fixed inset-0 w-full h-full z-[-2] overflow-hidden">
                ...
                {/* Improved gradient background with better visibility and top extension */}
                ...
                {/* Extra gradient layers to ensure top coverage */}
                <div className="absolute -top-5 left-0 right-0 h-[200px] bg-gradient-to-b from-indigo-50/95 to-transparent opacity-95" />
                
                {/* Subtle texture overlay */}
                <div className="absolute inset-0 opacity-[0.025] bg-[url('/noise-texture.svg')]" />
                
                {/* Decorative elements with improved opacity */}
                <div className="absolute -top-40 left-1/4 w-[60vw] h-[60vw] max-w-3xl max-h-3xl rounded-full bg-indigo-300 dark:bg-indigo-800 blur-[120px] opacity-[0.5] z-0" />
                <div className="absolute top-[5%] right-0 w-[40vw] h-[40vw] max-w-3xl max-h-3xl rounded-full bg-indigo-300 dark:bg-indigo-800 blur-[100px] opacity-[0.4] z-0" />
                ...
                <div className="absolute top-0 left-0 right-0 h-[120px] bg-gradient-to-b from-white/90 dark:from-gray-900/90 to-transparent z-0"></div>
              </div>
              
              <main className="flex min-h-screen w-full flex-col items-center justify-start py-4 pt-[70px] pb-[80px] px-safe-left px-safe-right relative z-10">
                {children}
              </main>
