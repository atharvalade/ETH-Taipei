...
const features = [
  ...
  },
  {
    ...
    description:
      "This template includes a modified auth card that can be easily customized to use your preferred authentication solution",
    demo: (
      <div className="flex items-center justify-center space-x-20">
        <Image alt="Components" src="/logo.png" width={50} height={50} />
      </div>
    ),
  },
  {
